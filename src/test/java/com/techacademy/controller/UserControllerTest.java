...
class UserControllerTest {
    ...
    void testGetList() throws Exception {
        ...
        User u0 = userlist.get(0);
        assertEquals(u0.getId(), 1);
        assertEquals(u0.getName(), "キラメキ太郎");
        User u1 = userlist.get(1);
        assertEquals(u1.getId(), 2);
        assertEquals(u1.getName(), "キラメキ次郎");
        User u2 = userlist.get(2);
        assertEquals(u2.getId(), 3);
        assertEquals(u2.getName(), "キラメキ花子");
    }
}
